  ...
  return (
    <section className="Value">
      ...
      <div className="grid sm:grid-cols-3 gap-10 sm:gap-4 items-center justify-center pb-10 sm:pb-16">
        {ValuesData.slice(0, 3).map((valueData) => {
          let colorclass = null;
          let imgbgclass = null;
          ...
          return (
            ...
            >
              <div className="flex gap-3 items-center">
                ...
                <span className="font-bold">{valueData.title}</span>
              </div>
              <p className="mt-4 text-black-400 text-sm ">{valueData.desc}</p>
            </div>
          );
        })}
        <div className="valuecard my-10 bg-blueColor flex flex-wrap gap-10 justify-between items-center rounded-xl p-8 md:mt-20 md:mb-8 sm:p-16 sm:col-span-3 bg-cover">
          <div className="left">
            ...
            <p className="font-extrabold text-2xl text-white">Let's Get Started!</p>
          </div>
          <div className="right">
            <button className="border-2 border-white rounded-lg text-lg font-semibold px-8 py-5 text-white hover:bg-white hover:text-blueColor transition-colors">
              Get Started
            </button>
          </div>
        </div>
